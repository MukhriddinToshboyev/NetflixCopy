  ...
  return (
    <div className="card-container">
      <section className="card-section">
        <div>
          <h2 className="card-section__text">More Reasons to Join </h2>
        </div>
        <div className="card">
          <ul className="card-items">
            <li className="card-item">
              <h2 className="card-item__title">Enjoy on your TV</h2>
            ...
            <li className="card-item">
              <h2 className="card-item__title">Watch everywhere</h2>
              <p className="card-item__text">
            ...
            <li className="card-item">
              <h2 className="card-item__title">Create profiles for kids</h2>
              <p className="card-item__text">
